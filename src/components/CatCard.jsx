...
const CatCard = ({ width, height, bgimg, text }) => {
    return (
        <div className="catcard d-flex justify-content-center align-items-center" style={{ width: width, height: height, backgroundImage: `url(${bgimg})`, objectFit: "cover", backgroundRepeat: "no-repeat" }}>
